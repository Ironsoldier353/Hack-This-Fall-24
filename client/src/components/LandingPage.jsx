...
const LandingPage = () => {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-r from-blue-200 via-teal-200 to-green-200 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
            {/* Dark mode toggle */}
            <header className="bg-white dark:bg-gray-800 shadow-lg shadow-gray-300 dark:shadow-gray-700">
            ...
            <section className="container mx-auto px-6 pt-24 pb-28">
                <div className="flex flex-col lg:flex-row items-center">
                    <div className="lg:w-1/2 space-y-6 md:space-y-8 text-center lg:text-left">
                        <h1 className="text-4xl md:text-5xl font-semibold text-gray-800 dark:text-gray-100 leading-tight">
                        ...
                        <div className="flex flex-col md:flex-row items-center space-y-4 md:space-y-0 md:space-x-6">
                            ...
                            <button
                                className="border-2 border-teal-600 text-teal-600 dark:text-teal-400 px-8 py-4 rounded-full shadow-lg hover:bg-teal-50 dark:hover:bg-gray-700 transform hover:scale-105 transition-all duration-300"
            ...
            {/* How to Use Section */}
            <section className="container mx-auto px-6 py-24 bg-white dark:bg-gray-800 rounded-lg shadow-lg shadow-teal-200 dark:shadow-gray-700" id="how-to-use">
                <h2 className="text-3xl font-bold text-center mb-6 text-teal-600 dark:text-teal-400">How to USE?</h2>
            ...
            {/* Call to Action */}
            <section className="bg-gradient-to-r from-teal-600 to-green-600 dark:from-teal-700 dark:to-green-700 text-white py-24">
                <div className="container mx-auto px-6 text-center">
                    ...
                    <button
                        onClick={openModal}
                        className="bg-white dark:bg-gray-800 text-teal-600 dark:text-teal-400 px-8 py-4 rounded-full hover:bg-teal-50 dark:hover:bg-gray-700 transition-colors"
                    >
                        Start Free Trial
                    </button>
                </div>
            ...
            <section className="container mx-auto px-6 py-24" id="faq-section">
                <h2 className="text-3xl font-bold text-center mb-8 text-teal-600 dark:text-teal-400">Frequently Asked Questions</h2>
                <div className="space-y-6">
                    {[
                        ...
                        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-xl dark:shadow-gray-700" key={index}>
                            <button
                                className="w-full text-left p-6 font-semibold text-teal-600 dark:text-teal-400 flex justify-between items-center"
            ...
            {isModalOpen && (
                <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center px-6">
                    <div className="bg-white dark:bg-gray-800 p-8 rounded-lg shadow-xl w-full max-w-md">
                        <h3 className="text-lg md:text-xl font-semibold mb-6 text-gray-800 dark:text-gray-100">We currently only support disease prediction. Would you like to try it?</h3>
                        <div className="flex justify-center space-x-6">
                            ...
                            <button
                                onClick={closeModal}
                                className="border-2 border-teal-600 text-teal-600 dark:text-teal-400 px-6 py-3 rounded-full hover:bg-teal-50 dark:hover:bg-gray-700 transition-colors"
                            >
                                No, Close
                            </button>
                        </div>
